      ...
      >
        ...
        <div className="p-6 md:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-[#B91C3C]/10 rounded-xl flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#B91C3C]/10 text-[#B91C3C] text-xs font-bold">
                  {request.bloodGroup}
                </span>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-white/10">
            <a
              ...
              className="w-full flex items-center justify-center gap-2 bg-[#B91C3C] hover:bg-[#B91C3C] text-white py-3.5 rounded-xl font-bold transition-colors shadow-lg shadow-[#B91C3C]/20"
            >
